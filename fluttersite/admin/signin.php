...
if(isset($_POST['girisformu'])) {
    ...
    if(!$email || !$sifre) {
        ?>
        <script>
            alert('email ve sifre alanının doldurulması gerekiyor.');
            window.location.href='index.php';
        </script>
        <?php
    }else{
        $kntrl = $VT_baglan->prepare(statement:'SELECT email, sifre, id FROM kullanicilar WHERE email= :email and sifre= :sifre');
...
<body>
	...
	<div class="sin-w3-agile">
		...
		<form action="#" method="post">
			<div class="username">
				<span class="username">Email Adresi:</span>
